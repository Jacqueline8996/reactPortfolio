                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active" data-bs-interval="300000">
                            <img class="d-block w-100" src="Images/Let's_Plan_a_Day!.png" alt="First slide"/>
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100" src="Images/pokemonCard.png" alt="Second slide"/>
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100" src="Images/RetroBurger.png" alt="Third slide"/>
                            <div class="carousel-caption d-none d-md-block bg-dark mb-4">
                                <h5> 
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100" src="Images/WeatherDash.png" alt="fourth slide"/>
                            <div class="carousel-caption d-none d-md-block bg-dark mb-4">
                                <h5> 
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100" src="Images/Quiz_Start.png" alt="Fith slide"/>
                            <div class="carousel-caption d-none d-md-block bg-dark mb-4">
                                <h5> 
                          ...
                          <div class="carousel-item">
                            <img class="d-block w-100" src="Images/noteTaker.png" alt="Six slide"/>
                            <div class="carousel-caption d-none d-md-block bg-dark mb-4">
                                <h5> 
