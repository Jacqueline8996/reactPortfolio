...
const SLIDE = [
    ...
    { alt:"Third slide",title:'Retro Burger',href:"https://gentle-temple-81178.herokuapp.com/",src:`${ThirdImage}`,Description:"This app will allow users to add Burgers of there choice. They then will be able to determine what to do with added burgers. If they have been uneaten then they can be consumed or delted. Once Eaten the burger can be deleted.",state:"carousel-item",repo:"https://github.com/Jacqueline8996/burgers"},
    { alt:"Fourth slide",title:'Weather Dashboard',href:"https://jacqueline8996.github.io/WeatherDash/",src:`${FourImage}`,Description:"A Weather dashboard where you can place your zip code and get a daily and a 5day forcast ",state:"carousel-item",repo:"https://github.com/Jacqueline8996/WeatherDash"},
    { alt:"Fith slide",title:'Quiz game',href:"https://jacqueline8996.github.io/Homework4/",src:`${FithImage}`,Description:"A Timead Quiz used to test knowledge of coding and will be keeping the score of the user.",state:"carousel-item",repo:"https://github.com/Jacqueline8996/CodeQuiz"},
    { alt:"Six slide",title:'Note Taker',href:"https://frozen-journey-71877.herokuapp.com/",src:`${SixImage}`,Description:"A responsive Note taking application",state:"carousel-item",repo:"https://github.com/Jacqueline8996/noteTaker"},
    { alt:"Seven slide",title:'Team Profile',href:"https://github.com/Jacqueline8996/TeamProfile",src:`${SevenImage}`,Description:"Using node moduels you are able to create a team profile",repo:"https://github.com/Jacqueline8996/TeamProfile"},
